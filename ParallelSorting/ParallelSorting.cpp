// Adapted from https://blogs.msdn.microsoft.com/vcblog/2018/09/11/using-c17-parallel-algorithms-for-better-performance/
...
int main() {
	...
	// time how long it takes to sort them serially:
	...
	// time how long it takes to sort them in parallel:
	for (int i = 0; i < iterationCount; ++i) {
		vector<double> sorted(doubles);
		const auto startTime = high_resolution_clock::now();
